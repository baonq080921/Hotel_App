...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="carousel-image" src="./image/hotel2.jpeg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/hotel3.gif">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/hotel4.jpeg">
            </div>
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="vinpearlogo" src="./image/vinpearl_login_logo-01.png" alt="logo">
            <img src="./image/vinpearl_login_logo-02.png" alt="membership logo">
        </div>

        <div class="auth_container">
            <!--============ login =============-->
            <div id="Log_in">
                <h2 style="font-size: 15px; font-size:small;">Đăng nhập/Log In</h2>
                <div class="role_btn">
...
?>
            ...
            ?>
            <div id="sign_up">
                <h2 style="font-size: 15px; font-size: small;">Đăng ký/Sign Up</h2>
